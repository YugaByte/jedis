...
public abstract class PipelineBase extends Queable implements BinaryRedisPipeline, RedisPipeline {
  ...
  public Response<List<String>> tsLastN(String key, int limit) {
    getClient(key).tsLastN(key, limit);
    return getResponse(BuilderFactory.STRING_LIST);
  }

  public Response<List<byte[]>> tsLastN(byte[] key, byte[] limit) {
    getClient(key).tsLastN(key, limit);
    return getResponse(BuilderFactory.BYTE_ARRAY_LIST);
  }
  ...
  @Override
  public Response<Long> tscard(String key) {
    getClient(key).tscard(key);
    return getResponse(BuilderFactory.LONG);
  }

  @Override
  public Response<Long> tscard(byte[] key) {
    getClient(key).tscard(key);
    return getResponse(BuilderFactory.LONG);
  }
  ...
  public Response<String> set(String key, String value, String expx, int time) {
    getClient(key).set(key, value, expx, time);
    return getResponse(BuilderFactory.STRING);
  }
  ...
  public Response<String> set(byte[] key, byte[] value, byte[] expx, int time) {
    getClient(key).set(key, value, expx, time);
    return getResponse(BuilderFactory.STRING);
  }
